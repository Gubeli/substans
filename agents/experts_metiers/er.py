"""
ExpertRetail - Agent Expert Experts Metiers
Spécialisé en Commerce de détail, e-commerce, distribution
"""
...
class ExpertRetail:
    def __init__(self):
        self.agent_id = "ER"
        self.nom = "ExpertRetail"
        self.specialisation = "Commerce de détail, e-commerce, distribution"
        self.description = "Expert en retail, distribution, e-commerce et expérience client"
